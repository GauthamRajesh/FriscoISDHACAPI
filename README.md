...
Base API URL: https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/
...
``` javascript
axios.get("https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/students/gpa/john/doe").then((res) => {
...
``` cURL
curl -X GET \
  'https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/students/gpa/john/doe' \
  -H 'Accept: */*' \
...
Example Request (Axios):
``` javascript
axios.get("https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/students/info/john/doe").then((res) => {
...
``` cURL
curl -X GET \
  'https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/students/info/john/doe' \
  -H 'Accept: */*' \
  -H 'User-Agent: Thunder Client (https://www.thunderclient.io)'
```
...
Example Request (Axios):
``` javascript
axios.get("https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/students/schedule/john/doe").then((res) => {
    console.log(res.data);
}).catch((error) => {
    console.log(error);
})
...
``` cURL
curl -X GET \
  'https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/students/schedule/john/doe' \
  -H 'Accept: */*' \
  -H 'User-Agent: Thunder Client (https://www.thunderclient.io)'
```
...
Example Request (Axios):
``` javascript
axios.get("https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/students/currentclasses/john/doe").then((res) => {
    console.log(res.data);
}).catch((error) => {
    console.log(error);
})
...
``` cURL
curl -X GET \
  'https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/students/currentclasses/john/doe' \
  -H 'Accept: */*' \
  -H 'User-Agent: Thunder Client (https://www.thunderclient.io)'
```
...
``` cURL
curl -X POST \
  'https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/predictedGPA' \
  -H 'Accept: */*' \
  -H 'User-Agent: Thunder Client (https://www.thunderclient.io)' \
...
``` cURL
curl -X GET \
  'https://gradual-env.eba-57kd6mpm.us-east-2.elasticbeanstalk.com/satdates' \
  -H 'Accept: */*' \
  -H 'User-Agent: Thunder Client (https://www.thunderclient.io)'
```
